...
class MixingRatioGuide extends StatefulWidget {
  const MixingRatioGuide({super.key});

  @override
  State<MixingRatioGuide> createState() => _MixingRatioGuideState();
}

class _MixingRatioGuideState extends State<MixingRatioGuide> {
  @override
